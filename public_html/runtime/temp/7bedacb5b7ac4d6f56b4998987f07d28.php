<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:82:"/www/web/yuewu/public_html/application/admin/view/teacher/teacher_file_select.html";i:1551324973;}*/ ?>
 <!DOCTYPE html>
<html>
                    ...
                    <div class="ibox-content">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped">
                                ...
                                <tbody>
<?php if(is_array($teacher_file_select) || $teacher_file_select instanceof \think\Collection || $teacher_file_select instanceof \think\Paginator): $i = 0; $__LIST__ = $teacher_file_select;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                    <tr>
                                        <!-- <td>
                                            <input type="checkbox" class="i-checks" name="input[]">
                                        </td> -->
                                        <td><?php echo $vo['file_id']; ?></td>
                                        <td><img src="/public/uploads/<?php echo $vo['teacher_portrait']; ?>" style="width: 34px;height: 34px; display: flex; border-radius: 50%; align-items: center; justify-content: center; overflow: hidden;"></td>
                                        ...
                                        <td> <?php if(strtoupper($vo['file_state']) == 1): ?>正常
                                            ...
                                            <?php endif; ?></td>
                                        <td>
                                        <a type="button" class="btn btn-outline btn-info" href="<?php echo url('file/file_judge',['file_id'=>$vo['file_id'],'user_teacher_id'=>$vo['user_teacher_id'],'file_type'=>$vo['file_type']]); ?>">详情</a>
                                        <a type="button" class="btn btn-outline btn-danger" href="<?php echo url('Teacher/teacher_file_closure',['file_id'=>$vo['file_id'],'user_teacher_id'=>$vo['user_teacher_id']]); ?>">封停</a>                
<!--  <a type="button" class="btn btn-outline btn-danger" href="<?php echo url('user/file_',['user_teacher_id'=>$vo['user_teacher_id']]); ?>" onClick="return confirm('确定要封停   <<?php echo $vo['file_name']; ?>>   ?')">封停</a> -->
                                        </td>
                                    </tr>
<?php endforeach; endif; else: echo "" ;endif; ?>
                                </tbody>
                                <?php echo $teacher_file_select->render(); ?>
                            </table>
                            <a type="button" class="btn btn-outline btn-info" href="<?php echo url('teacher/user_teacher_details',['user_teacher_id'=>$user_teacher_id]); ?>">返回</a>
