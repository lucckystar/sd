<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:91:"/www/web/yuewu/public_html/application/admin/view/organization/organization_check_list.html";i:1547445697;}*/ ?>
 <!DOCTYPE html>
<html>
            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <div class="row">
                        <form action="<?php echo url('organization/organization_check_list'); ?>">
                            <div class="col-sm-3">
...
<?php if(is_array($organization_select) || $organization_select instanceof \think\Collection || $organization_select instanceof \think\Paginator): $i = 0; $__LIST__ = $organization_select;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                    <tr>
                                        ...
                                        <td ><img width="55" height="55" alt="机构头像" src="/public/uploads/<?php echo $vo['organization_portrait']; ?>"/></td>
                                        ...
                                        <?php elseif(strtoupper($vo['organization_state']) == 3): ?>待审核
                                        <?php endif; ?>
                                        </td>
                                        
                                        <td>
                                        <a type="button" class="btn btn-outline btn-info" href="<?php echo url('organization/organization_apply_details',['organization_id'=>$vo['organization_id']]); ?>">详情</a>
                                        <a type="button" class="btn btn-outline btn-success" href="<?php echo url('organization/organization_pass',['organization_id'=>$vo['organization_id']]); ?>">通过</a>
                                        <a type="button" class="btn btn-outline btn-danger" href="<?php echo url('organization/organization_reject',['organization_id'=>$vo['organization_id']]); ?>" onClick="return confirm('确定要驳回   <<?php echo $vo['user_name']; ?>>    的申请   ?')">驳回</a>
                                        </td>
                                    </tr>
