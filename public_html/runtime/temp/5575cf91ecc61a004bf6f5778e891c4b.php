<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:76:"/www/web/yuewu/public_html/application/admin/view/file/file_pic_details.html";i:1551323780;}*/ ?>
<!-- 
...
<!--[if IE 9 ]><html class="ie9"><![endif]
    ...
    <body id="skin-blur-violate">
        ...
        <div class="clearfix" style="width: 1000px;margin-left: 560px;margin-top: 50px;">
            <a class="btn btn-outline btn-info" href="<?php echo url('file/file_pic_list',['file_type'=>3]); ?>">返回</a>
        </div>
