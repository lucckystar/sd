<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:69:"/www/web/yuewu/public_html/application/admin/view/file/file_list.html";i:1551323872;}*/ ?>
 <!DOCTYPE html>
<html>
            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>
                            <?php if(strtoupper($file_type['file_type']) == 1): ?>视频列表
                            <?php elseif(strtoupper($file_type['file_type']) == 2): ?>音乐列表
                            <?php else: ?>图片列表
                            <?php endif; ?>
                        </h5>
                    </div>
                            ...
                            <table class="table table-striped">
                                <thead>
                                    <tr>
                                        <!-- <th width="70px"></th> -->
                                        <th width="170px">
                                        <?php if(strtoupper($file_type['file_type']) == 1): ?>视频id
                                            <?php elseif(strtoupper($file_type['file_type']) == 2): ?>音乐id
                                            <?php else: ?>图片id
                                        <?php endif; ?>
                                        </th>
                                        ...
                                        <th width="170px">
                                        <?php if(strtoupper($file_type['file_type']) == 1): ?>视频名称
                                            <?php elseif(strtoupper($file_type['file_type']) == 2): ?>音乐名称
                                            <?php else: ?>图片名称
                                        <?php endif; ?>
                                        </th>
                                        <th width="200px">
                                        <?php if(strtoupper($file_type['file_type']) == 1): ?>视频封面
                                            <?php elseif(strtoupper($file_type['file_type']) == 2): ?>音乐封面
                                            <?php else: ?>图片封面
                                        <?php endif; ?>
                                    </th>
                                        <th width="170px">
                                        <?php if(strtoupper($file_type['file_type']) == 1): ?>视频收藏量
                                            <?php elseif(strtoupper($file_type['file_type']) == 2): ?>音乐收藏量
                                            <?php else: ?>图片收藏量
                                        <?php endif; ?>
                                    </th>
                                        <th width="170px">
                                        <?php if(strtoupper($file_type['file_type']) == 1): ?>视频所属
                                            <?php elseif(strtoupper($file_type['file_type']) == 2): ?>音乐所属
                                            <?php else: ?>图片所属
                                        <?php endif; ?>
                                    </th>
                                        <th width="170px">
                                        <?php if(strtoupper($file_type['file_type']) == 1): ?>视频状态
                                            <?php elseif(strtoupper($file_type['file_type']) == 2): ?>音乐状态
                                            <?php else: ?>图片状态
                                        <?php endif; ?>
                                    </th>
                                        <th>操作</th>
