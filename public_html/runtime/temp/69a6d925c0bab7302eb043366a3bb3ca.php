<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:69:"/www/web/yuewu/public_html/application/admin/view/index/homepage.html";i:1550390103;}*/ ?>
<!DOCTYPE html>
<html>
...
<body class="gray-bg">
                        ...
                        <div class="row row-sm text-center">
                            <div class="col-xs-6">
                                <div class="panel padder-v item">
                                    <div class="h1 text-info font-thin h1">9999</div>
    ...
    <!-- Flot -->
    <script src="/public/static/admin/js/plugins/flot/jquery.flot.js"></script>
    <script src="/public/static/admin/js/plugins/flot/jquery.flot.tooltip.min.js"></script>
    <script src="/public/static/admin/js/plugins/flot/jquery.flot.resize.js"></script>
    <script src="/public/static/admin/js/plugins/flot/jquery.flot.pie.js"></script>
    <!-- 自定义js -->
    <script src="/public/static/admin/js/content.js"></script>
    <!--flotdemo-->
