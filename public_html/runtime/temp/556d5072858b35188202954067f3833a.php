<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:92:"/www/web/yuewu/public_html/application/admin/view/curriculum/teacher_curriculum_details.html";i:1547692680;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="ibox-content">
          <form method="post" action="<?php echo url('Curriculum/organization_curriculum_update'); ?>" class="form-horizontal ajax-commit" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input disabled type="hidden" name="curriculum_id" value="<?php echo $teacher_curriculum_find['curriculum_id']; ?>">
                <input disabled class="form-control verify" type="text" name="curriculum_name" value="<?php echo $teacher_curriculum_find['curriculum_name']; ?>">
              </div>
            </div>
            <div class="form-group">
              <label class="col-sm-2 control-label">课程导师</label>
              <div class="col-sm-10">
                <input disabled class="form-control verify" type="text" name="curriculum_admin" value="<?php echo $teacher_curriculum_find['curriculum_admin']; ?>">
              </div>
            </div>
            <div class="form-group">
              <label class="col-sm-2 control-label">课程负责人</label>
              <div class="col-sm-10">
                <input disabled class="form-control verify" type="text" name="organization_business_hours" value="<?php echo $teacher_curriculum_find['teacher_name']; ?>">
              </div>
            </div>
            <div class="form-group">
              <label class="col-sm-2 control-label">收藏数</label>
              <div class="col-sm-10">
                <input disabled class="form-control verify" type="text" name="organization_synopsis" value="<?php echo $teacher_curriculum_find['curriculum_collect']; ?>">
              </div>
            </div>
            <div class="form-group">
              <label class="col-sm-2 control-label">有效时间</label>
              <div class="col-sm-10">
                <input disabled class="form-control verify" type="text" name="curriculum_state" value="<?php if(strtoupper($teacher_curriculum_find['curriculum_state']) != 1): ?>长期有效
                <?php else: ?><?php echo date("Y-m-d",$teacher_curriculum_find['curriculum_start_time']); ?>至<?php echo date("Y-m-d",$teacher_curriculum_find['curriculum_over_time']); endif; ?>">
              </div>
            </div>
            <div class="form-group">
              <label class="col-sm-2 control-label">最大人数</label>
              <div class="col-sm-10">
                <input disabled class="form-control verify" type="text" name="max_people_number" value="<?php echo $teacher_curriculum_find['max_people_number']; ?>">
              </div>
            </div>
            <div class="form-group">
              <label class="col-sm-2 control-label">舞蹈种类</label>
              <div class="col-sm-10">
                <input disabled class="form-control verify" type="text" name="dance_type_name" value="<?php echo $teacher_curriculum_find['dance_type_name']; ?>">
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <select class="form-control m-b" name="curriculum_state" style="height: 35px;padding-bottom: 0px;padding-top: 0px;padding-left: 12px;">
                    <option selected="selected" value="<?php echo $teacher_curriculum_find['curriculum_state']; ?>">
                    <?php if(strtoupper($teacher_curriculum_find['curriculum_state']) == 1): ?>正常
                    <?php elseif(strtoupper($teacher_curriculum_find['curriculum_state']) == 2): ?>封停
                    <?php endif; ?>
                    </option>
            ...
            <div class="form-group">
                <div class="col-sm-4 col-sm-offset-2">
                    ...
                    <a class="btn btn-white" type="reset" href="<?php echo url('Curriculum/teacher_curriculum_list'); ?>">返回</a>
                </div>
            </div>
          </form>
        </div>
