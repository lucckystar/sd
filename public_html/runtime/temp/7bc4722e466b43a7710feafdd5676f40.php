<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:86:"/www/web/yuewu/public_html/application/admin/view/information/dance_type_add_show.html";i:1545456971;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="col-sm-12">
      <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
          <form method="post" action="<?php echo url('Information/dance_type_add'); ?>" class="form-horizontal ajax-commit" enctype="multipart/form-data">
            <div class="form-group">
              <label class="col-sm-2 control-label">舞蹈类型名称</label>
              <div class="col-sm-10">
                <input class="form-control verify" type="text" name="dance_type_name" value="">
              </div>
            </div>
