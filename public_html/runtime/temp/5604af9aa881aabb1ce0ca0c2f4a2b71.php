<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:59:"D:\wamp\www\shop/application/admin\view\goods\property.html";i:1529925115;}*/ ?>
<html>
<head>
  <meta charset="utf-8">
...
<div class="wrapper">
  <div class="data-box">
    <div class="db-header">商品属性列表</div>
    <div class="db-body">
      <table>
          <thead>
              <tr>
          ...
          <tbody>
              ...
              <tr>
                  <td><?php echo $v['goods_property_id']; ?></td>
                  <td><?php echo $v['goods_property_name']; ?></td>
                  <td>
                      <a class="btn btn-xs btn-primary" href="<?php echo url('property_edit',['id'=>$v['goods_property_id']]); ?>">编辑</a>
                      <a class="btn btn-xs btn-danger" href="<?php echo url('property_del',['id'=>$v['goods_property_id']]); ?>">删除</a>
                  </td>
              </tr>
    ...
    <div class="db-footer">
        <a type="button" class="btn btn-success" href="<?php echo url(property_add); ?>">添加</a>
