<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:97:"/www/web/yuewu/public_html/application/admin/view/curriculum/teacher_closure_curriculum_list.html";i:1547627226;}*/ ?>
 <!DOCTYPE html>
<html>
                    ...
                    <div class="ibox-content">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped">
                                ...
                                <tbody>
<?php if(is_array($teacher_closure_curriculum_list) || $teacher_closure_curriculum_list instanceof \think\Collection || $teacher_closure_curriculum_list instanceof \think\Paginator): $i = 0; $__LIST__ = $teacher_closure_curriculum_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                    <tr>
                                        ...
                                        <a type="button" class="btn btn-outline btn-success" href="<?php echo url('Curriculum/curriculum_recover',['curriculum_id'=>$vo['curriculum_id']]); ?>" onClick="return confirm('确定要恢复   <<?php echo $vo['curriculum_name']; ?>>   ?')">恢复</a>
                                        </td>
                                    </tr>
...
<!--                             <a href="<?php echo url('Information/videos_add'); ?>" type="button" class="btn btn-outline btn-success">添加</a>
 -->                        </div>
                        <div style="align-content: center;" class="btn-group">
                            <?php echo $teacher_closure_curriculum_list->render(); ?>
                        </div>
                    </div>
                </div>
