<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:80:"/www/web/yuewu/public_html/application/admin/view/teacher/user_teacher_list.html";i:1551362624;}*/ ?>
 <!DOCTYPE html>
<html>
            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <div class="row">
                        <form action="<?php echo url('teacher/user_teacher_list'); ?>">
                            <div class="col-sm-3">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped">
                                ...
                                <tbody>
<?php if(is_array($teacher_list) || $teacher_list instanceof \think\Collection || $teacher_list instanceof \think\Paginator): $i = 0; $__LIST__ = $teacher_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                    <tr>
                                        <!-- <td>
                                        ...
                                        <td ><img width="55" height="55" alt="视频封面" src="/public/uploads/<?php echo $vo['teacher_portrait']; ?>"/></td>
                                        ...
                                        <td>
                                        <a type="button" class="btn btn-outline btn-info" href="<?php echo url('Teacher/user_teacher_details',['user_teacher_id'=>$vo['user_teacher_id']]); ?>">详情</a>
                                        <a type="button" class="btn btn-outline btn-info" href="<?php echo url('Teacher/user_teacher_update_show',['user_teacher_id'=>$vo['user_teacher_id']]); ?>">修改</a>
                                        <a type="button" class="btn btn-outline btn-danger" href="<?php echo url('Teacher/user_teacher_closure',['user_teacher_id'=>$vo['user_teacher_id']]); ?>" onClick="return confirm('确定要封停   <<?php echo $vo['teacher_name']; ?>>   ?')">封停</a>
                                        </td>
                                    </tr>
