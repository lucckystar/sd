<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:73:"/www/web/yuewu/public_html/application/admin/view/file/file_pic_list.html";i:1551323872;}*/ ?>
 <!DOCTYPE html>
<html>
...
<!--                                         <?php echo $vo['file_state']; ?>
 -->                                        </td>
                                        <td>
                                        <a type="button" class="btn btn-outline btn-info" href="<?php echo url('File/file_pic_details',['file_id'=>$vo['file_id']]); ?>">内容</a>
