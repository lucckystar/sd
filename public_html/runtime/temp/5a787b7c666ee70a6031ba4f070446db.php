<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:89:"/www/web/yuewu/public_html/application/admin/view/file/organization_file_pic_details.html";i:1551355669;}*/ ?>
<!-- 
...
<!--[if IE 9 ]><html class="ie9"><![endif]
    ...
    <body id="skin-blur-violate">
        ...
        <div class="clearfix" style="width: 1000px;margin-left: 560px;margin-top: 50px;">
            <h3><?php echo $videos_find['file_name']; ?></h3>
        </div>
        <div class="clearfix" style="width: 1000px;margin-left: 560px;margin-top: 50px;">
            <img src="/public/uploads/<?php echo $videos_find['file_content']; ?>">
        </div>
        <div class="clearfix" style="width: 1000px;margin-left: 560px;margin-top: 50px;">
            <a class="btn btn-outline btn-info" href="<?php echo url('organization/organization_file_select',['organization_id'=>$videos_find['organization_id']]); ?>">返回</a>
        </div>
