<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:94:"/www/web/yuewu/public_html/application/admin/view/curriculum/organization_curriculum_list.html";i:1547617315;}*/ ?>
 <!DOCTYPE html>
<html>
                    ...
                    <div class="ibox-content">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped">
                                ...
                                <tbody>
<?php if(is_array($organization_curriculum_list) || $organization_curriculum_list instanceof \think\Collection || $organization_curriculum_list instanceof \think\Paginator): $i = 0; $__LIST__ = $organization_curriculum_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                    <tr>
...
<!--                             <a href="<?php echo url('Information/videos_add'); ?>" type="button" class="btn btn-outline btn-success">添加</a>
 -->                        </div>
                        <div style="align-content: center;" class="btn-group">
                            <?php echo $organization_curriculum_list->render(); ?>
                        </div>
                    </div>
                </div>
