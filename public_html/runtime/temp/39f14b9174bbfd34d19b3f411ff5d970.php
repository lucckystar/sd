<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:74:"/www/web/yuewu/public_html/application/admin/view/order/teacher_order.html";i:1549894745;}*/ ?>
 <!DOCTYPE html>
<html>
                    ...
                    <div class="ibox-content">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped">
                                ...
                                <tbody>
<?php if(is_array($teacher_order_list) || $teacher_order_list instanceof \think\Collection || $teacher_order_list instanceof \think\Paginator): $i = 0; $__LIST__ = $teacher_order_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                    <tr>
                                        <!-- <td>
...
<?php endforeach; endif; else: echo "" ;endif; ?>
                        ...
                        <div style="align-content: center;" class="btn-group">
                            <?php echo $teacher_order_list->render(); ?>
                        </div>
                    </div>
                </div>
