<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:66:"/www/web/yuewu/public_html/application/admin/view/index/index.html";i:1551277763;}*/ ?>
<!DOCTYPE html>
<html>
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="<?php echo url('Discounts/discounts_list'); ?>">优惠券列表</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                <a class="J_menuItem" href="<?php echo url('File/file_music_list',['file_type'=>2]); ?>">音乐列表</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="<?php echo url('File/file_pic_list',['file_type'=>3]); ?>">图片列表</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="<?php echo url('order/organization_order'); ?>">机构明细记录</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="<?php echo url('order/teacher_order'); ?>">教师明细记录</a>
                            </li>
                            <!-- <li>
                                <a class="J_menuItem" href="<?php echo url('order/user_order'); ?>">用户明细记录</a>
                            </li> -->
                        </ul>
                    </li>
                    <!-- <li>
