<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:70:"/www/web/yuewu/public_html/application/area/view/file/file_report.html";i:1548948396;}*/ ?>
 <!DOCTYPE html>
<html>
...
<?php if(is_array($file_report) || $file_report instanceof \think\Collection || $file_report instanceof \think\Paginator): $i = 0; $__LIST__ = $file_report;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                    <tr>
                                        ...
                                        <td>
                                        <a type="button" class="btn btn-outline btn-info" href="<?php echo url('/',['file_id'=>$vo['file_id']]); ?>">详情</a>
