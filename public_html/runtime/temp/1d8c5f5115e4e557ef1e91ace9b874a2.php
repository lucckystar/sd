<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:92:"/www/web/yuewu/public_html/application/admin/view/organization/organization_file_select.html";i:1551355392;}*/ ?>
 <!DOCTYPE html>
<html>
...
<?php if(is_array($organization_select) || $organization_select instanceof \think\Collection || $organization_select instanceof \think\Paginator): $i = 0; $__LIST__ = $organization_select;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                    <tr>
                                        ...
                                        <td><img src="/public/uploads/<?php echo $vo['organization_portrait']; ?>" style="width: 34px;height: 34px; display: flex; border-radius: 50%; align-items: center; justify-content: center; overflow: hidden;"></td>
                                        ...
                                        <td> <?php if(strtoupper($vo['file_state']) == 1): ?>正常
                                            ...
                                            <?php endif; ?></td>
                                        <td>
                                        <a type="button" class="btn btn-outline btn-info" href="<?php echo url('file/organization_file_judge',['file_id'=>$vo['file_id'],'organization_id'=>$vo['organization_id'],'file_type'=>$vo['file_type']]); ?>">详情</a>
                                        <a type="button" class="btn btn-outline btn-danger" href="<?php echo url('organization/organization_file_closure',['file_id'=>$vo['file_id'],'organization_id'=>$vo['organization_id']]); ?>">封停</a>                
<!--  <a type="button" class="btn btn-outline btn-danger" href="<?php echo url('user/file_',['organization_id'=>$vo['organization_id']]); ?>" onClick="return confirm('确定要封停   <<?php echo $vo['file_name']; ?>>   ?')">封停</a> -->
                                        </td>
                                    </tr>
<?php endforeach; endif; else: echo "" ;endif; ?>
                            ...
                            <a type="button" class="btn btn-outline btn-info" href="<?php echo url('organization/organization_details',['organization_id'=>$organization_id]); ?>">返回</a>
