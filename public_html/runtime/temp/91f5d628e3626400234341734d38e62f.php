<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:71:"/www/web/yuewu/public_html/application/admin/view/file/file_report.html";i:1551356691;}*/ ?>
 <!DOCTYPE html>
<html>
            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <div class="row">
                        <form action="<?php echo url('file/file_report'); ?>">
                            <div class="col-sm-3">
...
<!--                         <form action="">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped">
                                ...
                                <tbody>
<?php if(is_array($file_report) || $file_report instanceof \think\Collection || $file_report instanceof \think\Paginator): $i = 0; $__LIST__ = $file_report;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                    <tr>
                                        <!-- <td>
                                        ...
                                        <td>
                                        <a type="button" class="btn btn-outline btn-info" href="<?php echo url('file/report_file_judge',['file_id'=>$vo['file_id']]); ?>">详情</a>
                                        <a type="button" class="btn btn-outline btn-success" href="<?php echo url('File/file_closure_pass',['file_id'=>$vo['file_id']]); ?>">通过</a>
                                        <!-- <a type="button" class="btn btn-outline btn-info" href="<?php echo url('Information/banner_edit_show',['file_id'=>$vo['file_id']]); ?>">编辑</a> -->
                                        <a type="button" class="btn btn-outline btn-danger" href="<?php echo url('File/file_',['file_id'=>$vo['file_id']]); ?>" onClick="return confirm('确定要封停   <<?php echo $vo['file_name']; ?>>   ?')">驳回</a>
                                        </td>
                                    </tr>
