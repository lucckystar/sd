<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:83:"/www/web/yuewu/public_html/application/admin/view/information/banner_edit_show.html";i:1545448173;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="col-sm-12">
      <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
          <form method="post" action="<?php echo url('Information/banner_edit'); ?>" class="form-horizontal ajax-commit" enctype="multipart/form-data">
            <!-- <div class="form-group">
              <label class="col-sm-2 control-label">轮播图id</label>
              <div class="col-sm-10">
                <input class="form-control verify" type="text" name="banner_id" value="<?php echo $banner_find['banner_id']; ?>" >
              </div>
            </div> -->
            <input type="hidden" value="<?php echo $banner_find['banner_id']; ?>" name="banner_id">
            <div class="form-group">
              <label class="col-sm-2 control-label">轮播图名称</label>
              <div class="col-sm-10">
                <input class="form-control verify" type="text" name="banner_name" value="<?php echo $banner_find['banner_name']; ?>">
              </div>
            </div>
            <div class="form-group">
              <label class="col-sm-2 control-label">轮播图排序</label>
              <div class="col-sm-10">
                <input class="form-control verify" type="text" name="banner_sort" value="<?php echo $banner_find['banner_sort']; ?>">
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input type="file" class="cropper-fileone" name="banner_content" field="banner_content" upload="">
                 <!-- <div class="imglist">
                  <div>
                    <img class="img-thumbnail" width="800" height="300" src="/public/uploads/<?php echo $banner_find['banner_content']; ?>"/>
