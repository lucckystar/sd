<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:89:"/www/web/yuewu/public_html/application/admin/view/curriculum/closure_curriculum_list.html";i:1547537714;}*/ ?>
 <!DOCTYPE html>
<html>
...
<?php if(is_array($organization_closure_curriculum_list) || $organization_closure_curriculum_list instanceof \think\Collection || $organization_closure_curriculum_list instanceof \think\Paginator): $i = 0; $__LIST__ = $organization_closure_curriculum_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                    <tr>
                                        ...
                                        <td>
                                        <a type="button" class="btn btn-outline btn-info" href="<?php echo url('Curriculum/',['curriculum_id'=>$vo['curriculum_id']]); ?>">详情</a>
                                        <a type="button" class="btn btn-outline btn-info" href="<?php echo url('Curriculum/',['curriculum_id'=>$vo['curriculum_id']]); ?>">修改</a>
                                        <a type="button" class="btn btn-outline btn-success" href="<?php echo url('Curriculum/',['curriculum_id'=>$vo['curriculum_id']]); ?>" onClick="return confirm('确定要封停   <<?php echo $vo['curriculum_name']; ?>>   ?')">恢复</a>
                                        </td>
                                    </tr>
