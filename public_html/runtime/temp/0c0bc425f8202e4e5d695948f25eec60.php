<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:68:"/www/web/yuewu/public_html/application/admin/view/account/login.html";i:1551258364;}*/ ?>
<!DOCTYPE html>
<html>
...
<div class="middle-box text-center loginscreen  animated fadeInDown">
    <div>
        <!-- <div>
            <h1 class="logo-name">舞</h1>
        </div> -->
        <h2>乐舞后台</h2>
        <form class="m-t ajax-commit" role="form" method="post" action="<?php echo url('Account/loginupdate'); ?>">
            <div class="form-group">
                <input type="text" class="form-control verify" placeholder="用户名" name="username">
            </div>
            <div class="form-group">
