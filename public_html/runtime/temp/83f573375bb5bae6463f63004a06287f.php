<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:83:"/www/web/yuewu/public_html/application/admin/view/file/report_file_judge_video.html";i:1551356801;}*/ ?>
<!-- 
                ...
                <div class="block-area">
                    ...
                    <div class="row" style="margin-top: 100px;">
                        ...
                        <div class="col-md-6 m-b-20" style="padding-left: 0px;margin-left: 0px;width: 1000px;object-fit: fill;">
                            ...
                            <a class="btn btn-outline btn-info" href="<?php echo url('file/file_report'); ?>">返回</a>
                        </div>
