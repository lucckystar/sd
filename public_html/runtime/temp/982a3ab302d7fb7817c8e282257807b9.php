<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:94:"/www/web/yuewu/public_html/application/admin/view/organization/organization_apply_details.html";i:1547433573;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="col-sm-12">
      <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
          <form method="post" action="<?php echo url('organization/organization_pass',['organization_id'=>$organization_find['organization_id']]); ?>" class="form-horizontal ajax-commit" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <img src="/public/uploads/<?php echo $organization_find['organization_portrait']; ?>" style="width: 100px;height: 100px;">
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-sm-10">
                ...
                <input class="form-control verify" disabled type="text" name="organization_name" value="<?php echo $organization_find['organization_name']; ?>">
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input class="form-control verify" disabled type="text" name="organization_site" value="<?php echo $organization_find['organization_site']; ?>">
              </div>
            </div>
            <div class="form-group">
              <label class="col-sm-2 control-label">机构营业时间</label>
              <div class="col-sm-10">
                <input class="form-control verify" disabled type="text" name="organization_business_hours" value="<?php echo $organization_find['organization_business_hours']; ?>">
              </div>
            </div>
            <div class="form-group">
              <label class="col-sm-2 control-label">机构简介</label>
              <div class="col-sm-10">
                <input class="form-control verify" disabled type="text" name="organization_synopsis" value="<?php echo $organization_find['organization_synopsis']; ?>">
              </div>
            </div>
            <div class="form-group">
              <label class="col-sm-2 control-label">机构客服电话</label>
              <div class="col-sm-10">
                <input class="form-control verify" disabled type="text" name="organization_service" value="<?php echo $organization_find['organization_service']; ?>">
              </div>
            </div>
            <div class="form-group">
              <label class="col-sm-2 control-label">机构舞蹈类型</label>
              <div class="col-sm-10">
                <input class="form-control verify" disabled type="text" name="organization_type" value="<?php echo $organization_find['organization_type']; ?>">
              </div>
            </div>
<!--             <div class="form-group">
              <label class="col-sm-2 control-label">机构等级</label>
              <div class="col-sm-10">
                <input class="form-control verify" disabled type="text" name="organization_level" value="<?php echo $organization_find['organization_level']; ?>">
              </div>
            </div> -->
<!--             <div class="form-group">
            ...
            <div class="form-group">
              <label class="col-sm-2 control-label">机构申请时间</label>
              <div class="col-sm-10">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                ...
                <img src="/public/uploads/<?php echo $organization_find['organization_cover']; ?>" style="width: 400px;height: 200px;">
              </div>
            </div>
<!--             <div class="form-group">
...
<!--             <div class="form-group">
            ...
            <div class="form-group">
                <div class="col-sm-4 col-sm-offset-2">
                    ...
                    <a class="btn btn-outline btn-danger" type="reset" href="<?php echo url('Organization/organization_reject',['organization_id'=>$organization_find['organization_id']]); ?>">驳回请求</a>
                    <a class="btn btn-white" type="reset" href="<?php echo url('Organization/organization_check_list',['organization_id'=>$organization_find['organization_id']]); ?>">返回</a>
                </div>
            </div>
          </form>
        </div>
